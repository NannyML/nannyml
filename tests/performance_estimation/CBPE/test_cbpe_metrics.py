...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            pd.DataFrame(
                {
                    'key': ['[0:19999]', '[20000:39999]', '[40000:49999]'],
                    'estimated_roc_auc': [0.9690827692140925, 0.9634851917907716, 0.9612426494258154],
                    'estimated_f1': [0.9479079222515973, 0.9294599255593571, 0.9245516739588603],
                    'estimated_precision': [0.9436121782324026, 0.9217384775672881, 0.9159308766434395],
                    'estimated_recall': [0.9522429574319092, 0.9373118323003661, 0.933336292106975],
                    'estimated_specificity': [0.9434949869571513, 0.9153107130639775, 0.906418072349441],
                    'estimated_accuracy': [0.9478536003143163, 0.9266531619733247, 0.9204715081119524],
                }
            ),
        ),
        (
