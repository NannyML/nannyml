...
@pytest.mark.parametrize(
    ...
    [
        (
            {'timestamp_column_name': 'timestamp'},
            {'kind': 'feature_drift', 'plot_reference': False, 'column_name': 'f1', 'method': 'kolmogorov_smirnov'},
        ),
        ({}, {'kind': 'feature_drift', 'plot_reference': False, 'column_name': 'f1', 'method': 'kolmogorov_smirnov'}),
        (
            {'timestamp_column_name': 'timestamp'},
            {'kind': 'feature_drift', 'plot_reference': True, 'column_name': 'f1', 'method': 'kolmogorov_smirnov'},
        ),
        ({}, {'kind': 'feature_drift', 'plot_reference': True, 'column_name': 'f1', 'method': 'kolmogorov_smirnov'}),
        (
            {'timestamp_column_name': 'timestamp'},
            {'kind': 'feature_drift', 'plot_reference': False, 'column_name': 'f3', 'method': 'chi2'},
        ),
        ({}, {'kind': 'feature_drift', 'plot_reference': False, 'column_name': 'f3', 'method': 'chi2'}),
        (
            {'timestamp_column_name': 'timestamp'},
            {'kind': 'feature_drift', 'plot_reference': True, 'column_name': 'f3', 'method': 'chi2'},
        ),
        ({}, {'kind': 'feature_drift', 'plot_reference': True, 'column_name': 'f3', 'method': 'chi2'}),
        (
            {'timestamp_column_name': 'timestamp'},
            {'kind': 'feature_distribution', 'plot_reference': False, 'column_name': 'f1'},
        ),
        ({}, {'kind': 'feature_distribution', 'plot_reference': False, 'column_name': 'f1'}),
        (
            {'timestamp_column_name': 'timestamp'},
            {'kind': 'feature_distribution', 'plot_reference': True, 'column_name': 'f1'},
        ),
        ({}, {'kind': 'feature_distribution', 'plot_reference': True, 'column_name': 'f1'}),
        (
            {'timestamp_column_name': 'timestamp'},
            {'kind': 'feature_distribution', 'plot_reference': False, 'column_name': 'f3'},
        ),
        ({}, {'kind': 'feature_distribution', 'plot_reference': False, 'column_name': 'f3'}),
        (
            {'timestamp_column_name': 'timestamp'},
            {'kind': 'feature_distribution', 'plot_reference': True, 'column_name': 'f3'},
        ),
        ({}, {'kind': 'feature_distribution', 'plot_reference': True, 'column_name': 'f3'}),
    ],
    ids=[
