...
def test_constant_threshold_init_sets_instance_attributes(lower, upper):  # noqa: D103
...
def test_constant_threshold_init_sets_default_instance_attributes():  # noqa: D103
...
def test_constant_threshold_init_raises_threshold_exception_when_breaking_lower_upper_strict_order(  # noqa: D103
    lower, upper
):
...
def test_constant_threshold_init_raises_invalid_arguments_exception_when_given_wrongly_typed_arguments(  # noqa: D103
...
@pytest.mark.parametrize('lower, upper', [(0.0, 1.0), (0, 1), (-1, 1), (None, 1.0), (0.1, None), (None, None)])
def test_constant_threshold_returns_correct_threshold_values(  # noqa: D103
    lower, upper
):
...
def test_standard_deviation_threshold_init_sets_instance_attributes(  # noqa: D103
    lower_multiplier, upper_multiplier, offset_from
):
...
def test_standard_deviation_threshold_init_sets_default_instance_attributes():  # noqa: D103
...
def test_standard_deviation_threshold_init_raises_invalid_arguments_exception_when_given_wrongly_typed_arguments(  # noqa: D103, E501
    lower_multiplier, upper_multiplier, param, param_type
):
    with pytest.raises(
        InvalidArgumentsException,
...
def test_standard_deviation_threshold_applies_offset_from(offset_from, expected):  # noqa: D103
...
def test_standard_deviation_threshold_correctly_applies_std_lower_multiplier(  # noqa: D103
...
def test_standard_deviation_threshold_treats_none_multiplier_as_no_threshold(  # noqa: D103
    std_lower_multiplier, std_upper_multiplier, exp_lower_threshold, exp_upper_threshold
):
...
def test_standard_deviation_threshold_correctly_returns_thresholds(  # noqa: D103
    low_mult, up_mult, offset_from, exp_low_threshold, exp_up_threshold
):
...
def test_standard_deviation_threshold_raises_threshold_exception_when_negative_lower_multiplier_given():  # noqa: D103
...
def test_standard_deviation_threshold_raises_threshold_exception_when_negative_upper_multiplier_given():  # noqa: D103
...
def test_standard_deviation_threshold_deals_with_nan_values():  # noqa: D103
