.. _multiclass-confusion-matrix-estimation-iw:

====================
Importance Weighting
====================

Let's see how to use NannyML to estimate the :term:`confusion matrix<Confusion Matrix>`
of multiclass classification models in the absence of target data using Importance
Weighting. To find out how
...
.. nbimport::
    :path: ./example_notebooks/Tutorial - Estimating Confusion Matrix - IW - Multiclass Classification.ipynb
    :cells: 1 3 4 5 7
...
.. image:: ../../../../_static/tutorials/performance_estimation/multiclass/multiclass-cm-iw-analysis-with-ref.svg
