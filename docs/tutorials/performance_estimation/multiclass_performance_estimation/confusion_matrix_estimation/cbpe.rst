.. _multiclass-confusion-matrix-estimation-cbpe:
...
of multiclass classification models in the absence of target data using CBPE.
To find out how CBPE estimates performance, read the :ref:`explanation of Confidence-based
