...
- When performing sentiment monitored, targets may be entirely unavailable without significant human effort, so estimation is the only feasible way to attain metrics.
