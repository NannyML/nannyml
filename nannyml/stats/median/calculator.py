...
class SummaryStatsMedianCalculator(AbstractCalculator):
    ...
    def __init__(
        ...
        """
        super(SummaryStatsMedianCalculator, self).__init__(
    ...
    def _fit(self, reference_data: pd.DataFrame, *args, **kwargs):
        """Fits the Summary Stats Median calculator to a set of reference data."""
    ...
    @log_usage(UsageEvent.STATS_MEDIAN_RUN)
